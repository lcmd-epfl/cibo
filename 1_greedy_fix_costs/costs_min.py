...
for exp_config in benchmark:
    ...
    name = "./figures/{}_{}.png".format(exp_config["dataset"], exp_config["max_batch_cost"])
    plot_utility_BO_vs_RS(y_better_BO_ALL, y_better_RANDOM_ALL, name="utility_"+name)
    plot_costs_BO_vs_RS(running_costs_BO_ALL, running_costs_RANDOM_ALL, name="costs_"+name)
